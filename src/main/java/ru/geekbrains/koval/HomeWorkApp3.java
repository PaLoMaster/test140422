...
public class HomeWorkApp3 {
    ...
    public static void change0To1() {
        ...
        System.out.println(Arrays.toString(change));//после
    }
    ...
    public static void lessThan6() {
        int[] mass = {1, 5, 3, 2, 11, 4, 5, 2, 4, 8, 9, 1};//до
        System.out.print(Arrays.toString(mass));
        System.out.println();
        for (int i = 0; i < mass.length; i++) {
            if (mass[i] < 6) {
    ...
    public static void lenInitialValue(int len, int iniyialValue) {
        ...
        //System.out.println(Arrays.toString(leni)); проверка
    ...
    public static void maxMin() {
        ...
        System.out.println("search max and min nymber is of this array: " + Arrays.toString(maxMin));
